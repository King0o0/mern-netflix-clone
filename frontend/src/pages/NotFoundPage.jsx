...
const NotFoundPage = () => {
  return (
    <div
    className="min-h-screen bg-cover bg-center flex flex-col justify-center text-white"
    ...
    >
     ...
     <main className="text-center error-page--content z-10">
        ...
        <p className="mb-6 text-xl">
            Sorry, we can't find page. You'll find lots to explore on the home page.
        </p>
